...
function () {
  ...
  _createClass(Vehicle, [{
    key: "printVehicleMake",
    value: function printVehicleMake() {
...
function (_Human) {
  ...
  function Person() {
    ...
    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(Person).call(this));
    _this2.name = "Gilwell Muhati";
    return _this2;
  }
